...
<div class="row justify-content-center mt-5">
    <div class="col-md-8">
        ...
        <div class="card">
            <div class="card-header  text-white" style="background-color: #947054;">Register</div>
            <div class="card-body">
...
<?php echo $__env->make('auth.layouts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\BookAVenue\resources\views/auth/register.blade.php ENDPATH**/ ?>